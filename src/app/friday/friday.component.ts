...
export class FridayComponent implements OnInit, OnDestroy {
  ...
  private misteries: TEvangelion = {
    1: { book: "lc", chapter: 22, start: 41, end: 46, weekday: "fri" },
    2: { book: "jo", chapter: 19, start: 17, end: 18, weekday: "fri" },
    3: { book: "lc", chapter: 23, start: 33, end: 34, weekday: "fri" },
    4: { book: "jo", chapter: 19, start: 25, end: 27, weekday: "fri" },
    5: { book: "lc", chapter: 23, start: 44, end: 49, weekday: "fri" },
  };
