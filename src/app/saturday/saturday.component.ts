...
export class SaturdayComponent implements OnInit, OnDestroy {
  ...
  private misteries: TEvangelion = {
    1: { book: "lc", chapter: 24, start: 1, end: 7, weekday: "fri" },
    2: { book: "jo", chapter: 21, start: 1, end: 14, weekday: "fri" },
    3: { book: "jo", chapter: 21, start: 15, end: 19, weekday: "fri" },
    4: { book: "lc", chapter: 24, start: 45, end: 52, weekday: "fri" },
    5: { book: "jo", chapter: 20, start: 21, end: 23, weekday: "fri" },
  };
